    ...
    return (
        <section className="py-[60px] px-[120px] bg-background">
                <div className="max-w-[1200px] mx-auto flex flex-col items-center gap-16">
                  <h2 className="font-display text-[36px] leading-[120%] tracking-[-1.44px] text-foreground text-center">
                    Introducing Obscura
                  </h2>
                  <p className="font-display text-[20px] leading-[120%] tracking-[-0.4px] text-muted-foreground text-center max-w-[1200px]">
